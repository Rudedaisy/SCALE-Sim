...
paths = ["outputs/VGG16_CIFAR10_32x32_os/", "outputs/VGG16_CIFAR10_32x32_os_PENNI/", "outputs/VGG16_CIFAR10_32x32_os_squeeze/", "outputs/VGG16_CIFAR10_32x32_os_PENNIv2/"]
...
ax.legend(['Baseline','Decouple','Squeeze','Sq+Dc'], loc=2)
ax.grid(True)
plt.show()
...
ax.legend(['Baseline','Decouple','Squeeze','Sq+Dc'], loc=1)
ax.grid(True)
plt.show()
...
def plotCycleUtil():
    ...
    ax.legend(['Decouple','Sq+Dc'], loc=2)
    ax.grid(True)
    plt.show()
    ...
    ax.legend(['baseline','Decouple','Sq+Dc'], loc=3)
    ax.grid(True)
    plt.show()
